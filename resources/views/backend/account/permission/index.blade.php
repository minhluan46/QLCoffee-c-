@extends('layouts.admin_backend')
@section('content')
 <div class="main_content_iner ">

   <div class="btn-pm">
    <div class="mb-3 btn-1">
      <a class="btn btn-success" href="#"><span class="btn-label"><i class="fa fa-plus"></i></span>Thêm Mới</a>
              ...
              <table class="table">
                ...
                <tbody>
                  <tr>
                    ...
                    <td>1</td>
                    <td> <a href="#">Quyền Siêu Cao Cấp</a></td>
                    <td>
                             <div class="checkbox_wrap d-flex align-items-center">
                    <label class="lms_checkbox_1" for="course_2">
