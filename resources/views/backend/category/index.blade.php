...
<div class="main_content_iner ">
 <div class="btn-pm">
  <div class="mb-3 btn-1">
    <a class="btn btn-success" href="{{ route('add.category')}}"><span class="btn-label"><i class="fa fa-plus"></i></span>Thêm Mới</a>
            ...
            <table class="table">
              ...
              <tbody class="data-cate">
                ...
                <tr>
                 ...
                 <td> <a class="line-3" href=""><?=htmlspecialchars_decode($value->mota)?></a></td>
                 <td>
